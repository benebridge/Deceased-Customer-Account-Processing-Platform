...
class RealisticDocumentGenerator:
    ...
    def generate_california_death_certificate(self, case_data, case_dir, quality='high'):
        ...
        c.setFont("Helvetica", 10)
        c.drawString(200, y_position, fake.name_male().upper())
    ...
    def generate_california_drivers_license(self, case_data, case_dir, quality='high'):
        ...
        # Name - use BENEFICIARY's name (this is their ID for proof of identity)
        ...
        # Physical characteristics - use BENEFICIARY's sex (this is their ID)
        sex = case_data.get('beneficiary_sex', random.choice(['M', 'F']))
...
class SyntheticDataGenerator:
    ...
    def generate_beneficiary_persona(self, deceased_name):
        ...
        # Generate sex first, then gender-appropriate name
        sex = random.choice(['M', 'F'])
